...
public class AirplaneTest {
    ...
    void testInvalidModel(){
        String model = null;
        Throwable exception = assertThrows(IllegalArgumentException.class,()->{airplane.setAirplaneModel(model);});
    ...
    void testInvalidBusinessSitsNumber() {
        int number = -10;
        Throwable exception = assertThrows(IllegalArgumentException.class,()->{airplane.setBusinessSitsNumber(number);});
    ...
    void testInvalidEconomySitsNumber() {
        int number = -1;
        Throwable exception = assertThrows(IllegalArgumentException.class,()->{airplane.setEconomySitsNumber(number);});
    ...
    void testInvalidCrewSitsNumber() {
        int number = -10;
        Throwable exception = assertThrows(IllegalArgumentException.class,()->{airplane.setCrewSitsNumber(number);});
    ...
    void testTotalSitsNumberExceed300(){
        ...
        airplane.setBusinessSitsNumber(businessSitsNumber);
        airplane.setEconomySitsNumber(economySitsNumber);
        Throwable exception = assertThrows(IllegalArgumentException.class,()->{airplane.setCrewSitsNumber(crewSitsNumber);});
