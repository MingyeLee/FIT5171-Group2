...
public class ChooseTicket {
    ...
    public void chooseTicket(String city1, String city2) throws Exception {
        ...
        if (flight != null) {
            ...
            //TODO validate inside BuyTicket
            //buy ticket here
            buyTicket.buyTicket(ticket_id);
        } else //in case there is no direct ticket from city1 to city2
        {
            //SELECT a flight where depart_to = city2
            Flight depart_to = FlightCollection.getFlightInfo(city2);

            //TODO validate Flight
            //Not flight to city2
            if (depart_to == null) {
                System.out.println("Sorry, no flight to " + city2);
                return;
            }
